...
<ParamField status="200" type="array">
  ...
  <ParamField name="departureTime" type="string" format="date-time">
    Scheduled departure time
  </ParamField>
  <ParamField name="arrivalTime" type="string" format="date-time">
    Scheduled arrival time
  </ParamField>
  <ParamField name="aircraftType" type="string">
    Aircraft type
  </ParamField>
</ParamField>
